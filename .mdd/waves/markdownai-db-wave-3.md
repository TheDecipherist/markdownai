...
|---|---------|-----|------|--------|------------|
| 1 | db-security | docs/72-db-security.md | SPEC | planned | 68-db-executor, 66-db-raw-escape-hatch |
| 2 | db-caching | docs/73-db-caching.md | SPEC | planned | 68-db-executor, 28-caching |
| 3 | db-error-handling | docs/74-db-error-handling.md | SPEC | planned | 68-db-executor |
