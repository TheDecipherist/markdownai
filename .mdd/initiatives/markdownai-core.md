...
| Wave 4 | waves/markdownai-core-wave-4.md | `mai strip` produces clean markdown. MCP server starts and intercepts AI reads. All CLI commands functional. `@cache` works. | complete |
