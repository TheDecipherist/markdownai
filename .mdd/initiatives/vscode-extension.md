...
| Wave 3 | waves/vscode-extension-wave-3.md | `npm test` runs green in `packages/vscode`. An unclosed `@if` shows a red squiggly. README documents every feature. | complete |
