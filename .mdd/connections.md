...
graph LR
    ...
    72-db-security:::complete
    73-db-caching:::complete
    74-db-error-handling:::complete
    75-engine-bug-fixes:::complete
    76-packages-readmes:::complete
    77-claude-native:::complete
    78-lang-note:::complete
    79-vscode-preview:::complete
    80-run-state-tests:::complete
    81-lang-event:::complete
    82-engine-directive-tracing:::complete
    83-lang-foreach-set:::draft
    84-lang-frontmatter-ops:::draft
    85-lang-render-template:::draft
    86-lang-test-check:::draft
    87-lang-hash:::draft
    88-lang-write-directives:::draft
    89-mcp-constraints:::draft
    90-lang-dynamic-include-path:::complete
    91-lang-switch-operator:::complete
    ...
    01-parser --> 04-cli-core
    02-renderer --> 04-cli-core
    03-engine --> 04-cli-core
    01-parser --> 05-lang-header
    01-parser --> 06-lang-interpolation
    01-parser --> 07-lang-env
    07-lang-env --> 08-lang-macros
    08-lang-macros --> 10-lang-include
    09-lang-file-resolution --> 10-lang-include
    07-lang-env --> 11-lang-import
    09-lang-file-resolution --> 11-lang-import
    06-lang-interpolation --> 12-lang-conditionals
    07-lang-env --> 12-lang-conditionals
    13-lang-pipeline --> 14-lang-sources-list
    13-lang-pipeline --> 15-lang-sources-read
    07-lang-env --> 17-lang-connect
    13-lang-pipeline --> 18-lang-sources-db
    17-lang-connect --> 18-lang-sources-db
    13-lang-pipeline --> 19-lang-sources-http
    13-lang-pipeline --> 20-lang-sources-query
    08-lang-macros --> 21-lang-phases
    10-lang-include --> 21-lang-phases
    22-security-config --> 23-security-filesystem
    22-security-config --> 24-security-shell
    22-security-config --> 25-security-database
    22-security-config --> 26-security-http
    23-security-filesystem --> 27-security-immutable-rules
    24-security-shell --> 27-security-immutable-rules
    25-security-database --> 27-security-immutable-rules
    26-security-http --> 27-security-immutable-rules
    28-caching --> 30-mcp-server
    30-mcp-server --> 31-hook
    28-caching --> 32-cli-complete
    29-stripper --> 32-cli-complete
    30-mcp-server --> 32-cli-complete
    04-cli-core --> 33-e2e-test-suite
    07-lang-env --> 33-e2e-test-suite
    08-lang-macros --> 33-e2e-test-suite
    10-lang-include --> 33-e2e-test-suite
    11-lang-import --> 33-e2e-test-suite
    12-lang-conditionals --> 33-e2e-test-suite
    13-lang-pipeline --> 33-e2e-test-suite
    14-lang-sources-list --> 33-e2e-test-suite
    15-lang-sources-read --> 33-e2e-test-suite
    16-lang-sources-utilities --> 33-e2e-test-suite
    21-lang-phases --> 33-e2e-test-suite
    28-caching --> 33-e2e-test-suite
    29-stripper --> 33-e2e-test-suite
    32-cli-complete --> 33-e2e-test-suite
    04-cli-core --> 34-ai-consumer-mode
    12-lang-conditionals --> 34-ai-consumer-mode
    01-parser --> 35-ai-prompt
    03-engine --> 35-ai-prompt
    34-ai-consumer-mode --> 35-ai-prompt
    01-parser --> 36-ai-context-budget
    03-engine --> 36-ai-context-budget
    04-cli-core --> 36-ai-context-budget
    01-parser --> 37-ai-concepts
    03-engine --> 37-ai-concepts
    34-ai-consumer-mode --> 37-ai-concepts
    01-parser --> 38-ai-constraints
    03-engine --> 38-ai-constraints
    34-ai-consumer-mode --> 38-ai-constraints
    02-renderer --> 39-ai-format
    04-cli-core --> 39-ai-format
    30-mcp-server --> 39-ai-format
    33-e2e-test-suite --> 40-ai-e2e-accuracy
    34-ai-consumer-mode --> 40-ai-e2e-accuracy
    35-ai-prompt --> 40-ai-e2e-accuracy
    36-ai-context-budget --> 40-ai-e2e-accuracy
    37-ai-concepts --> 40-ai-e2e-accuracy
    38-ai-constraints --> 40-ai-e2e-accuracy
    39-ai-format --> 40-ai-e2e-accuracy
    30-mcp-server --> 41-mcp-e2e-protocol
    33-e2e-test-suite --> 41-mcp-e2e-protocol
    30-mcp-server --> 42-mcp-e2e-tools
    41-mcp-e2e-protocol --> 42-mcp-e2e-tools
    22-security-config --> 43-mcp-e2e-security
    23-security-filesystem --> 43-mcp-e2e-security
    27-security-immutable-rules --> 43-mcp-e2e-security
    42-mcp-e2e-tools --> 43-mcp-e2e-security
    30-mcp-server --> 44-mcp-e2e-ai-integration
    38-ai-constraints --> 44-mcp-e2e-ai-integration
    39-ai-format --> 44-mcp-e2e-ai-integration
    43-mcp-e2e-security --> 44-mcp-e2e-ai-integration
    45-mdd-markdownai-integration --> 46-mdd-token-optimization-analysis
    12-lang-conditionals --> 47-skill-context-variables
    30-mcp-server --> 47-skill-context-variables
    12-lang-conditionals --> 48-shell-inline
    20-lang-sources-query --> 48-shell-inline
    24-security-shell --> 48-shell-inline
    47-skill-context-variables --> 48-shell-inline
    03-engine --> 49-stdlib
    06-lang-interpolation --> 49-stdlib
    08-lang-macros --> 49-stdlib
    03-engine --> 50-match-operator
    51-package-scaffold --> 52-language-definition
    52-language-definition --> 53-syntax-highlighting
    52-language-definition --> 54-snippets
    51-package-scaffold --> 55-completion-provider
    52-language-definition --> 55-completion-provider
    55-completion-provider --> 56-hover-provider
    55-completion-provider --> 57-definition-provider
    56-hover-provider --> 57-definition-provider
    55-completion-provider --> 58-reference-panel
    55-completion-provider --> 59-diagnostics-provider
    59-diagnostics-provider --> 61-test-suite
    60-extension-settings --> 61-test-suite
    61-test-suite --> 62-readme-and-marketplace
    13-lang-pipeline --> 63-db-query-language
    17-lang-connect --> 63-db-query-language
    63-db-query-language --> 64-db-where-clause
    63-db-query-language --> 65-db-aggregate-operation
    64-db-where-clause --> 65-db-aggregate-operation
    63-db-query-language --> 66-db-raw-escape-hatch
    64-db-where-clause --> 67-db-queryplan-types
    65-db-aggregate-operation --> 67-db-queryplan-types
    67-db-queryplan-types --> 68-db-executor
    67-db-queryplan-types --> 69-db-adapter-interface
    69-db-adapter-interface --> 70-db-mongodb-adapter
    69-db-adapter-interface --> 71-db-sql-adapters
    66-db-raw-escape-hatch --> 72-db-security
    68-db-executor --> 72-db-security
    28-caching --> 73-db-caching
    68-db-executor --> 73-db-caching
    68-db-executor --> 74-db-error-handling
    03-engine --> 75-engine-bug-fixes
    08-lang-macros --> 75-engine-bug-fixes
    11-lang-import --> 75-engine-bug-fixes
    12-lang-conditionals --> 75-engine-bug-fixes
    20-lang-sources-query --> 75-engine-bug-fixes
    22-security-config --> 75-engine-bug-fixes
    01-parser --> 76-packages-readmes
    02-renderer --> 76-packages-readmes
    03-engine --> 76-packages-readmes
    04-cli-core --> 76-packages-readmes
    30-mcp-server --> 76-packages-readmes
    32-cli-complete --> 77-claude-native
    12-lang-conditionals --> 78-lang-note
    29-stripper --> 78-lang-note
    35-ai-prompt --> 78-lang-note
    32-cli-complete --> 79-vscode-preview
    51-package-scaffold --> 79-vscode-preview
    04-cli-core --> 80-run-state-tests
    33-e2e-test-suite --> 80-run-state-tests
    51-package-scaffold --> 80-run-state-tests
    03-engine --> 81-lang-event
    21-lang-phases --> 81-lang-event
    22-security-config --> 81-lang-event
    23-security-filesystem --> 81-lang-event
    27-security-immutable-rules --> 81-lang-event
    30-mcp-server --> 81-lang-event
    03-engine --> 82-engine-directive-tracing
    22-security-config --> 82-engine-directive-tracing
    81-lang-event --> 82-engine-directive-tracing
    01-parser --> 83-lang-foreach-set
    03-engine --> 83-lang-foreach-set
    06-lang-interpolation --> 83-lang-foreach-set
    08-lang-macros --> 83-lang-foreach-set
    01-parser --> 84-lang-frontmatter-ops
    03-engine --> 84-lang-frontmatter-ops
    09-lang-file-resolution --> 84-lang-frontmatter-ops
    23-security-filesystem --> 84-lang-frontmatter-ops
    01-parser --> 85-lang-render-template
    03-engine --> 85-lang-render-template
    08-lang-macros --> 85-lang-render-template
    09-lang-file-resolution --> 85-lang-render-template
    23-security-filesystem --> 85-lang-render-template
    01-parser --> 86-lang-test-check
    03-engine --> 86-lang-test-check
    24-security-shell --> 86-lang-test-check
    01-parser --> 87-lang-hash
    03-engine --> 87-lang-hash
    09-lang-file-resolution --> 87-lang-hash
    23-security-filesystem --> 87-lang-hash
    01-parser --> 88-lang-write-directives
    03-engine --> 88-lang-write-directives
    09-lang-file-resolution --> 88-lang-write-directives
    23-security-filesystem --> 88-lang-write-directives
    01-parser --> 89-mcp-constraints
    30-mcp-server --> 89-mcp-constraints
    38-ai-constraints --> 89-mcp-constraints
    09-lang-file-resolution --> 90-lang-dynamic-include-path
    10-lang-include --> 90-lang-dynamic-include-path
    12-lang-conditionals --> 90-lang-dynamic-include-path
    23-security-filesystem --> 90-lang-dynamic-include-path
    06-lang-interpolation --> 91-lang-switch-operator
    12-lang-conditionals --> 91-lang-switch-operator
    47-skill-context-variables --> 91-lang-switch-operator
    83-lang-foreach-set --> 91-lang-switch-operator
    90-lang-dynamic-include-path --> 91-lang-switch-operator
    03-engine --> 92-lang-allowed-function
    06-lang-interpolation --> 92-lang-allowed-function
    12-lang-conditionals --> 92-lang-allowed-function
    ...
    classDef deprecated fill:#999,stroke:#333,color:#fff
```
